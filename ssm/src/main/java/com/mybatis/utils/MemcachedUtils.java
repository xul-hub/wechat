...
public class MemcachedUtils {
    ...
    public static long addOrDecr(String key, long decr) { 
        return  addOrDecrExp(key,decr);
     } 
    
    private static long addOrDecrExp(String key, long decr) { 
        return cachedClient.addOrDecr(key, decr);
     } 
    ...
    private static class MemcachedLog {  
        ...
        public static void writeLog(String content) {  
            try {  
                logWrite.write("[" + PID + "] " + "- [" + formateTime(new Date().getTime()) + "]\r\n"  
                        + content);  
                logWrite.newLine();  
                logWrite.flush();  
            } catch (IOException e) {  
